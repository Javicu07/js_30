// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const orderedAge = inventors.sort(
      ...
      const liveInventors = inventors.reduce((acc, inventor) => {
      ...
      oldest.forEach(inventor => {
        console.log(`Inventor: ${inventor.first} ${inventor.last}, Years: ${inventor.passed-inventor.year}`);
      });
